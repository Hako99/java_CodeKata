...
public class Main {
    public static void main(String[] args) {
        int price = (int) (Math.random() * 2499) + 1;
        int money = (int) (Math.random() * 999999999) + 1;
        int count = (int) (Math.random() * 2499) + 1;

        System.out.println("기본 이용료 : " + price);
        System.out.println("소지금 : " +money);
        System.out.println("타고싶은 횟수 : " + count);
        ...
        System.out.println("모자른 금액 남으면 0");
